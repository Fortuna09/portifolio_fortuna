  ...
  return (
    ...
    >
      ...
      <div className="sobre-mim-container">
        ...
        <h2>Sobre Mim</h2>
        <p>
         Olá, sou Rafael Fortuna. Desenvolvedor de Software e estudante de Ciência da Computação na Universidade Federal de Alfenas (UNIFAL). <br />
         Sou especializado em construir interfaces web e mobile. Utilizando tecnologias como React, JavaScript e TypeScript, transformo conceitos em experiências digitais funcionais e otimizadas.<br />
